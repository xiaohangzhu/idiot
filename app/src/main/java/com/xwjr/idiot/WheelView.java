...
//            Log.d(TAG, "向上滚动");
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor(selectColor));
//                itemView.setBackgroundColor(Color.parseColor("#ffffff"));
            } else {
                itemView.setTextColor(Color.parseColor(defaultColor));
//                itemView.setBackgroundColor(Color.parseColor("#333333"));
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(Color.parseColor(separateColor));
    ...
    public void setSeparateColor(String separateColor) {
